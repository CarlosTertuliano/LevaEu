...
class GoogleMapsClient {
  ...
  Future<ReverseGeocodingResponse> latLonToAddress({
    ...
    try {
      ...
      throw Exception('Falha em obter as coordenadas: $err');
    }
  }
  ...
  Future<PlaceResponse> fetchPlaceDetails({
    ...
    try {
      ...
      throw Exception('Falha em obter os lugares: $err');
    }
  }
  ...
  Future<List<PlaceAutocompleteResponse>> fetchAutocompleteSuggestions({
    ...
    try {
      ...
      throw Exception('Falha no autocomplete: $err');
    }
  }
  ...
  Future<DirectionResponse> fetchDirections({
    ...
    try {
      ...
      throw Exception('Falha ao obter as direcoes: $err');
    }
  }
}
